...
function PricingSection({ className }: { className?: string }) {
  return (
    <div className="w-full md:px-4 px-2">
      <div className="site-container site-border border md:py-[80px] flex flex-col md:gap-24 gap-8">
        ...
        <div className="max-w-[1015px] xl:px-0 md:px-6 px-2 items-center justify-between w-full flex  mx-auto">
          <div className="flex min-w-full md:flex-row flex-col md:gap-0 gap-8 ">
            <div className="flex md:w-auto w-full">
              <div className="flex flex-col gap-8 md:pr-[5rem] pr-0 md:w-auto w-full">
