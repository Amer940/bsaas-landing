        ...
        <Container>
          <div className="w-full flex flex-col items-center">
            <div className="flex flex-col items-center text-center mx-auto md:mb-8 mb-6">
              <h2 className="md:text-50-medium text-[36px] leading-[110%] font-medium text-white">
                Take care of your <br />
                client today!
              </h2>
              <p className="md:text-18-medium text-[14px] font-normal text-white mt-4 md:max-w-165 max-w-66.25">
